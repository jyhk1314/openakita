...
class Plugin(PluginBase):
    def on_load(self, api: PluginAPI) -> None:
        ...
        from synapse.llm.providers.base import LLMProvider
        from synapse.llm.registries.base import ModelInfo, ProviderInfo, ProviderRegistry
        from synapse.llm.types import LLMRequest, LLMResponse, StopReason, TextBlock, Usage
