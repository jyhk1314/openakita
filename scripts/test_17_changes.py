...
from synapse.llm.config import load_endpoints_config, save_endpoints_config, validate_config
...
brain_src = read("src/synapse/core/brain.py")
...
agent_src = read("src/synapse/core/agent.py")
...
vs_src = read("src/synapse/memory/vector_store.py")
...
ret_src = read("src/synapse/prompt/retriever.py")
...
builder_src = read("src/synapse/prompt/builder.py")
...
gw_src = read("src/synapse/channels/gateway.py")
...
wiz_src = read("src/synapse/setup/wizard.py")
