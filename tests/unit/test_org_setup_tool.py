...
def handler():
    ...
    from synapse.tools.handlers.org_setup import OrgSetupHandler
...
class TestToolRegistration:
    ...
    def test_exported_from_definitions(self):
        from synapse.tools.definitions import ORG_SETUP_TOOLS
        assert len(ORG_SETUP_TOOLS) > 0

    def test_not_in_base_tools(self):
        from synapse.tools.definitions import BASE_TOOLS, ORG_SETUP_TOOLS
    ...
    def test_handler_has_create_handler(self):
        from synapse.tools.handlers.org_setup import create_handler
