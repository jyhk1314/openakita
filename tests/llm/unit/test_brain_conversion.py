...
def brain_converter():
    ...
    """
    with (
        patch("synapse.core.brain.settings") as mock_settings,
        patch("synapse.core.brain.get_default_config_path") as mock_config_path,
        patch("synapse.core.brain.LLMClient") as mock_client,
    ):
