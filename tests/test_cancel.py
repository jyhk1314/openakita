...
class TestTaskStateCancelEvent:
    ...
    def test_cancel_event_exists(self):
        ...
        from synapse.core.agent_state import TaskState
    ...
    def test_cancel_sets_event(self):
        ...
        from synapse.core.agent_state import TaskState, TaskStatus
...
class TestAgentStateCancelTask:
    ...
    def test_cancel_task_sets_event(self):
        ...
        from synapse.core.agent_state import AgentState
...
class TestReasonWithHeartbeatCancel:
    ...
    async def test_cancel_during_reason(self):
        ...
        from synapse.core.errors import UserCancelledError
        from synapse.core.agent_state import AgentState, TaskStatus
...
class TestStreamCancelFarewell:
    ...
    async def test_farewell_timeout_yields_default(self):
        ...
        with patch(
            "synapse.core.reasoning_engine.asyncio.wait_for",
