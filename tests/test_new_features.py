...
class TestSession:
    ...
    def test_session_creation(self):
        """测试会话创建"""
        from synapse.sessions import Session, SessionConfig
    ...
    def test_session_context(self):
        """测试会话上下文"""
        from synapse.sessions import Session, SessionContext
    ...
    def test_session_serialization(self):
        """测试会话序列化"""
        from synapse.sessions import Session
...
class TestUserManager:
    ...
    def test_user_creation(self, temp_storage):
        """测试用户创建"""
        from synapse.sessions import UserManager
...
class TestTriggers:
    ...
    def test_once_trigger(self):
        """测试一次性触发器"""
        from synapse.scheduler import OnceTrigger
    ...
    def test_interval_trigger(self):
        """测试间隔触发器"""
        from synapse.scheduler import IntervalTrigger
    ...
    def test_cron_trigger(self):
        """测试 Cron 触发器"""
        from synapse.scheduler import CronTrigger
...
class TestScheduledTask:
    ...
    def test_task_lifecycle(self):
        """测试任务生命周期"""
        from synapse.scheduler import ScheduledTask, TaskStatus
...
class TestTaskScheduler:
    ...
    async def test_scheduler_basic(self, temp_storage):
        """测试调度器基本功能"""
        from synapse.scheduler import TaskScheduler, ScheduledTask
...
class TestMessageTypes:
    ...
    def test_media_file(self):
        """测试媒体文件"""
        from synapse.channels import MediaFile
    ...
    def test_message_content(self):
        """测试消息内容"""
        from synapse.channels import MessageContent, MediaFile, MessageType
    ...
    def test_unified_message(self):
        """测试统一消息"""
        from synapse.channels import UnifiedMessage, MessageContent
    ...
    def test_message_plain_text(self):
        """测试消息转纯文本"""
        from synapse.channels import MessageContent, MediaFile
...
class TestTelegramAdapter:
    ...
    async def test_telegram_adapter_init(self):
        ...
        try:
            from synapse.channels.adapters import TelegramAdapter
...
class TestTelegramIntegration:
    ...
    async def test_telegram_full_flow(self):
        ...
        try:
            from synapse.channels.adapters import TelegramAdapter
            from synapse.channels import UnifiedMessage
...
class TestMediaHandler:
    ...
    def test_media_handler_init(self):
        """测试媒体处理器初始化"""
        from synapse.channels.media import MediaHandler
...
class TestMediaStorage:
    ...
    async def test_storage_basic(self, temp_storage):
        """测试基本存储功能"""
        from synapse.channels.media import MediaStorage
        from synapse.channels import MediaFile
...
class TestIntegration:
    ...
    async def test_full_message_flow(self, tmp_path):
        """完整消息流程测试"""
        from synapse.sessions import SessionManager
        from synapse.channels import MessageGateway, MessageContent, UnifiedMessage
        from synapse.channels.base import CLIAdapter
