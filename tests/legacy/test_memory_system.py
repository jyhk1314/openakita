...
from synapse.memory.types import Memory, MemoryType, MemoryPriority, ConversationTurn
...
from synapse.memory.daily_consolidator import DailyConsolidator
...
class TestSessionTaskManagement:
    ...
    def test_53_set_task(self):
        """测试设置任务"""
        from synapse.sessions.session import Session
