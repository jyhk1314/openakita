...
from synapse.plugins.api import PluginPermissionError
from synapse.plugins.hooks import HookRegistry
from synapse.plugins.manager import PluginManager
from synapse.plugins.manifest import BASIC_PERMISSIONS
...
async def test_llm_provider_cleanup_chain(tmp_path):
    ...
    from synapse.plugins import PLUGIN_PROVIDER_MAP
