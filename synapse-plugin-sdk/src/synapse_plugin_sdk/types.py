...
type hints without importing the full Synapse package.
"""
...
class UnifiedMessage:
    ...
    Mirrors ``synapse.channels.types.UnifiedMessage`` for type hints.
...
class OutgoingMessage:
    ...
    Mirrors ``synapse.channels.models.OutgoingMessage`` for type hints.
    """
