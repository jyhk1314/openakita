...
Or from the command line::
    ...
    python -m synapse_plugin_sdk.scaffold --id my-plugin --type tool --dir ./my-plugin
"""
...
from .version import MIN_SYNAPSE_VERSION, PLUGIN_API_VERSION, SDK_VERSION
...
PLUGIN_TEMPLATES: dict[str, dict[str, Any]] = {
    "tool": {
        ...
        "code": textwrap.dedent('''\
            """Example tool plugin for Synapse."""
    ...
    "channel": {
        ...
        "category": "channel",
        "code": textwrap.dedent('''\
            """Example channel plugin for Synapse."""
    ...
    "rag": {
        ...
        "category": "knowledge",
        "code": textwrap.dedent('''\
            """Example RAG plugin for Synapse."""

            from __future__ import annotations

            from synapse_plugin_sdk import PluginBase, PluginAPI, RetrievalSource
            from synapse_plugin_sdk.tools import tool_definition
    ...
    "memory": {
        ...
        "category": "memory",
        "code": textwrap.dedent('''\
            """Example memory backend plugin for Synapse."""
    ...
    "llm": {
        ...
        "category": "ai",
        "code": textwrap.dedent('''\
            """Example LLM provider plugin for Synapse."""
    ...
    "hook": {
        ...
        "category": "utility",
        "code": textwrap.dedent('''\
            """Example hook plugin for Synapse."""
...
def scaffold_plugin(
    ...
    manifest: dict[str, Any] = {
        ...
        "name": plugin_name,
        "version": version,
        "description": description or f"A {plugin_type} plugin for Synapse",
        "author": author,
        "license": "MIT",
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Scaffold a Synapse plugin")
