...
description: Search for Skills on the Synapse Platform Skill Store
system: true
handler: skill_store
...
Search for Skills on the Synapse Platform Skill Store.

## When to Use

- User wants to find or browse Skills on the Synapse marketplace
...
- **official**: Maintained by the Synapse team
