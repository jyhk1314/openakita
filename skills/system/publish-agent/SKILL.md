---
name: publish-agent
description: Publish a local Agent to the Synapse Platform Agent Store. Package and prepare a local Agent for publishing to the community hub.
version: 1.0.0
author: Synapse
---
...
Publish a local Agent to the Synapse Platform Agent Store.
