...
Synapse provides `scripts/init_skill.py` for scaffolding new skills:
...
In Synapse, `agents/openai.yaml` is extended with an `i18n` section for multi-language display:
...
Synapse provides runtime tools for managing skills:
...
Synapse keeps additional reference files not present in the upstream skill-creator:
